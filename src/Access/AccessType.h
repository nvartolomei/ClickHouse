...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(CREATE_RESOURCE_POOL, "", GLOBAL, ACCESS_MANAGEMENT) \
    M(ALTER_RESOURCE_POOL, "", GLOBAL, ACCESS_MANAGEMENT) \
    M(DROP_RESOURCE_POOL, "", GLOBAL, ACCESS_MANAGEMENT) \
    ...
    M(SHOW_RESOURCE_POOLS, "SHOW CREATE RESOURCE POOL, SHOW CREATE POOL, SHOW RESOURCE POOLS, SHOW POOLS", GLOBAL, SHOW_ACCESS) \
